...
# FEATURES_DIR = Path(__file__).resolve().parent.parent / 'data' /  'Features' /'datasets_features_advanced'
# EXPERIMENTS = ['A', 'B', 'C', 'D', 'FULL']
# OUTPUT_DIR = Path(__file__).resolve().parent.parent  / 'models' /  'baselines_features_eng_outputs' / 'outputs_baseline'
# MODEL_SAVE_ROOT = Path(__file__).resolve().parent.parent  /'models' /  'baselines_features_eng_outputs' / 'baseline_models'

# Chemin absolu du script : .../EEG_project/src/models/baselines/baseline_ML_feature_eng.py
SCRIPT_DIR = Path(__file__).resolve().parent          # .../baselines
MODELS_DIR = SCRIPT_DIR.parent                        # .../models
SRC_DIR = MODELS_DIR.parent                           # .../src
PROJECT_ROOT = SRC_DIR.parent                         # .../EEG_project


FEATURES_DIR = PROJECT_ROOT  / 'Features' / 'Features_eng'
EXPERIMENTS = ['A', 'B', 'C', 'D', 'FULL']
OUTPUT_DIR = PROJECT_ROOT / 'reports' / 'baseline_FeatEng' / 'outputs_baseline'
MODEL_SAVE_ROOT = PROJECT_ROOT / 'models' / 'baseline_FeatEng' / 'baseline_models'
