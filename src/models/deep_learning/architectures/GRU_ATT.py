"""
NeuroCap – GRU_Att sur datasets augmentés (A, B, C, D, FULL) + LOSO
GRU 2 couches + Attention Bahdanau + pré-encodeur CNN.
"""
import sys
...
class GRU_Att(nn.Module):
    """GRU 2 couches + Attention Bahdanau avec CNNPreEncoder."""
...
if __name__ == "__main__":
    dl_main_regression("GRU_Att", GRU_Att)