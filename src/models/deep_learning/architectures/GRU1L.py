"""
NeuroCap – GRU_1L sur datasets augmentés (A, B, C, D, FULL) + LOSO
GRU unidirectionnel 1 couche 64 unités + pré-encodeur CNN (1000 → ~63 pas).
"""
import sys
...
class GRU_1L(nn.Module):
    """GRU unidirectionnel 1 couche 64 unités avec CNNPreEncoder."""
...
if __name__ == "__main__":
    dl_main_regression("GRU_1L", GRU_1L)