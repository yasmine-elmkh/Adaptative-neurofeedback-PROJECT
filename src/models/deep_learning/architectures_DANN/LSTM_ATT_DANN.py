"""NeuroCap – LSTM_ATT_DANN (LSTM 2 couches + Attention Bahdanau) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class LSTM_Att_DANN(nn.Module):
    """
    LSTM 2 couches + Attention Bahdanau + DANN.
    CNNPreEncoder → LSTM(2L) → Attention (feat_dim=64) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("LSTM_Att_DANN", LSTM_Att_DANN)
