"""NeuroCap – GRU2L_DANN (GRU 2 couches) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class GRU_2L_DANN(nn.Module):
    """
    GRU unidirectionnel 2 couches + DANN.
    CNNPreEncoder → GRU(2L) → dernier pas (feat_dim=64) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("GRU_2L_DANN", GRU_2L_DANN)
