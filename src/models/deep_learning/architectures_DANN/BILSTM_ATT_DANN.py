"""NeuroCap – BILSTM_ATT_DANN (BiLSTM 2 couches + Attention Bahdanau) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class BiLSTM_Att_DANN(nn.Module):
    """
    BiLSTM 2 couches + Attention Bahdanau + DANN.
    CNNPreEncoder → BiLSTM(2L) → Attention (feat_dim=128) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("BiLSTM_Att_DANN", BiLSTM_Att_DANN)
