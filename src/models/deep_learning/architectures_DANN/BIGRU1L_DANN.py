"""NeuroCap – BIGRU1L_DANN (BiGRU 1 couche) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class BiGRU_1L_DANN(nn.Module):
    """
    BiGRU 1 couche + DANN.
    CNNPreEncoder → BiGRU(1L) → dernier pas (feat_dim=128) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("BiGRU_1L_DANN", BiGRU_1L_DANN)
