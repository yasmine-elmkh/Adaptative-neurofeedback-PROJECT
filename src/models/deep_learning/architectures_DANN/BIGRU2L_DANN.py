"""NeuroCap – BIGRU2L_DANN (BiGRU 2 couches) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class BiGRU_2L_DANN(nn.Module):
    """
    BiGRU 2 couches + DANN.
    CNNPreEncoder → BiGRU(2L) → dernier pas (feat_dim=128) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("BiGRU_2L_DANN", BiGRU_2L_DANN)
