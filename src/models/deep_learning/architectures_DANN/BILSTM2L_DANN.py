"""NeuroCap – BILSTM2L_DANN (BiLSTM 2 couches) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class BiLSTM_2L_DANN(nn.Module):
    """
    BiLSTM 2 couches + DANN.
    CNNPreEncoder → BiLSTM(2L) → dernier pas (feat_dim=128) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("BiLSTM_2L_DANN", BiLSTM_2L_DANN)
