"""NeuroCap – LSTM2L_DANN sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class LSTM_2L_DANN(nn.Module):
    """
    LSTM unidirectionnel 2 couches + DANN.
    CNNPreEncoder → LSTM(2L) → dernier pas (feat_dim=64) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("LSTM_2L_DANN", LSTM_2L_DANN)
