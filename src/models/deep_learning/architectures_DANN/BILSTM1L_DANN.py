"""NeuroCap – BILSTM1L_DANN (BiLSTM 1 couche) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class BiLSTM_1L_DANN(nn.Module):
    """
    BiLSTM 1 couche + DANN.
    CNNPreEncoder → BiLSTM(1L) → dernier pas (feat_dim=128) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("BiLSTM_1L_DANN", BiLSTM_1L_DANN)
