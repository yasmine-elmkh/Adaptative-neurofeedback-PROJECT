"""NeuroCap – GRU1L_DANN (GRU 1 couche) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class GRU_1L_DANN(nn.Module):
    """
    GRU unidirectionnel 1 couche + DANN.
    CNNPreEncoder → GRU(1L) → dernier pas (feat_dim=64) → label_head + domain_head.
    """
...
if __name__ == '__main__':
    dann_main("GRU_1L_DANN", GRU_1L_DANN)
