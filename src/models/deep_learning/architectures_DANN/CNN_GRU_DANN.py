"""NeuroCap – CNN_GRU_DANN (CNN encoder → BiGRU + Attention) sur datasets augmentés (A, B, C, D, FULL) + LOSO"""
import sys
...
class CNN_GRU_Att_DANN(nn.Module):
    """
    CNN encoder → BiGRU + Attention + DANN.
    CNN réduit la séquence, BiGRU(2L) traite,
    ...
    def __init__(self, n_classes=N_CLASSES, hidden_size=64):
        ...
        self.gru = nn.GRU(128, hidden_size, 2, batch_first=True,
...
if __name__ == '__main__':
    dann_main("CNN_GRU_Att_DANN", CNN_GRU_Att_DANN)
