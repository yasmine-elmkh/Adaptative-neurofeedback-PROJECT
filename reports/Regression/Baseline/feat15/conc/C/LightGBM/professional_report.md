...
**Target :** `conc`  |  **Modèle :** `LightGBM`  |  **Exp :** `C`  |  **Date :** 2026-06-21 16:26
...
|---|---|---|
| AUC ROC | 0.6189 | 0.500 |
| PR-AUC | 0.6009 | 0.519 |
| Sensitivity (TPR) | 0.7182 | 0.500 |
| Specificity (TNR) | 0.4681 | 0.500 |
| PPV (Precision) | 0.5926 | — |
| NPV | 0.6066 | — |
| Balanced Accuracy | 0.5931 | 0.500 |
| MCC | 0.1926 | 0.000 |
| G-Mean | 0.5798 | 0.500 |
| F1 macro | 0.5889 | 0.500 |
| LR+ | 1.350 | >10 = très utile |
| LR− | 0.602 | <0.1 = très utile |
| Cohen κ | 0.1878 | 0.000 |
...
|---|---|---|
| AUC ROC | 0.6155 | [0.5990, 0.6319]  ✅ |
| F1 macro | 0.5468 | [0.5329, 0.5614]  ✅ |
| Sensitivity | 0.3999 | [0.3812, 0.4199]  — |
| Specificity | 0.7225 | [0.7037, 0.7420]  — |
| MCC | 0.1291 | [0.0995, 0.1593]  — |
...
| AUC ROC | 0.6155 | p=0.0000 | ✅ p<0.05 |
...
| AUC ROC | 0.6029 | 0.1153 | 19.1% | 🟡 moderate |
