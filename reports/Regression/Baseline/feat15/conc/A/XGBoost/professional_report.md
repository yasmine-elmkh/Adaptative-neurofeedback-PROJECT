...
|---|---|---|
| AUC ROC | 0.5996 | 0.500 |
| PR-AUC | 0.5880 | 0.521 |
| Sensitivity (TPR) | 0.7844 | 0.500 |
| Specificity (TNR) | 0.3877 | 0.500 |
| PPV (Precision) | 0.5826 | — |
| NPV | 0.6226 | — |
| Balanced Accuracy | 0.5860 | 0.500 |
| MCC | 0.1879 | 0.000 |
| G-Mean | 0.5514 | 0.500 |
| F1 macro | 0.5732 | 0.500 |
| LR+ | 1.281 | >10 = très utile |
| LR− | 0.556 | <0.1 = très utile |
| Cohen κ | 0.1747 | 0.000 |
...
|---|---|---|
| AUC ROC | 0.5937 | [0.5633, 0.6225]  ✅ |
| F1 macro | 0.5155 | [0.4880, 0.5388]  — |
| Sensitivity | 0.3625 | [0.3291, 0.3952]  — |
| Specificity | 0.7018 | [0.6700, 0.7361]  — |
| MCC | 0.0683 | [0.0147, 0.1170]  — |
...
| AUC ROC | 0.5933 | p=0.0000 | ✅ p<0.05 |
...
| ECE | 0.2613 | < 0.05 |
| MCE | 0.3984 | < 0.10 |
| Brier Score | 0.3200 | < 0.20 |
| Log-Loss | 0.9940 | minimiser |
...
| AUC ROC | 0.6032 | 0.0637 | 10.6% | 🟢 stable |
