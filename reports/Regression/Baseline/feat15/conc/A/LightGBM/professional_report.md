...
|---|---|---|
| AUC ROC | 0.6016 | 0.500 |
| PR-AUC | 0.6028 | 0.521 |
| Sensitivity (TPR) | 0.7749 | 0.500 |
| Specificity (TNR) | 0.3789 | 0.500 |
| PPV (Precision) | 0.5762 | — |
| NPV | 0.6071 | — |
| Balanced Accuracy | 0.5769 | 0.500 |
| MCC | 0.1679 | 0.000 |
| G-Mean | 0.5418 | 0.500 |
| F1 macro | 0.5637 | 0.500 |
| LR+ | 1.248 | >10 = très utile |
| LR− | 0.594 | <0.1 = très utile |
| Cohen κ | 0.1562 | 0.000 |
| Brier Score | 0.3039 | < 0.20 objectif |

## Niveau 2 — Intervalles de Confiance (Bootstrap 95%)

| Métrique | Valeur | CI 95% | Significatif |
|---|---|---|
| AUC ROC | 0.5972 | [0.5682, 0.6242]  ✅ |
| F1 macro | 0.5279 | [0.5036, 0.5516]  ✅ |
| Sensitivity | 0.3733 | [0.3413, 0.4067]  — |
| Specificity | 0.7157 | [0.6815, 0.7507]  — |
| MCC | 0.0946 | [0.0443, 0.1425]  — |
...
| AUC ROC | 0.5965 | p=0.0000 | ✅ p<0.05 |
...
| AUC ROC | 0.6099 | 0.0587 | 9.6% | 🟢 stable |
