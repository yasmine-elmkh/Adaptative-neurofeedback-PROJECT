...
**Target :** `stress`  |  **Modèle :** `SVR`  |  **Exp :** `B`  |  **Date :** 2026-06-21 17:23
...
|---|---|---|
| AUC ROC | 0.4787 | 0.500 |
| PR-AUC | 0.2668 | 0.282 |
| Sensitivity (TPR) | 0.4359 | 0.500 |
| Specificity (TNR) | 0.5308 | 0.500 |
| PPV (Precision) | 0.2677 | — |
| NPV | 0.7051 | — |
| Balanced Accuracy | 0.4833 | 0.500 |
| MCC | -0.0301 | 0.000 |
| G-Mean | 0.4810 | 0.500 |
| F1 macro | 0.4687 | 0.500 |
| LR+ | 0.929 | >10 = très utile |
| LR− | 1.063 | <0.1 = très utile |
| Cohen κ | -0.0280 | 0.000 |
...
| F1 macro | 0.4683 | [0.4524, 0.4834]  — |
| Sensitivity | 0.4354 | [0.4064, 0.4652]  — |
| Specificity | 0.5305 | [0.5125, 0.5477]  — |
| MCC | -0.0308 | [-0.0615, 0.0006]  — |
...
| AUC ROC | 0.5153 | 0.1104 | 21.4% | 🟡 moderate |
