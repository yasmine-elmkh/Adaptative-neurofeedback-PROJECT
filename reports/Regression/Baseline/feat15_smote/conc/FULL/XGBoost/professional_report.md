...
**Target :** `conc`  |  **Modèle :** `XGBoost`  |  **Exp :** `FULL`  |  **Date :** 2026-06-21 16:59
...
|---|---|---|
| AUC ROC | 0.6383 | 0.500 |
| PR-AUC | 0.6178 | 0.517 |
| Sensitivity (TPR) | 0.5401 | 0.500 |
| Specificity (TNR) | 0.6257 | 0.500 |
| PPV (Precision) | 0.6066 | — |
| NPV | 0.5602 | — |
| Balanced Accuracy | 0.5829 | 0.500 |
| MCC | 0.1663 | 0.000 |
| G-Mean | 0.5814 | 0.500 |
| F1 macro | 0.5813 | 0.500 |
| LR+ | 1.443 | >10 = très utile |
| LR− | 0.735 | <0.1 = très utile |
| Cohen κ | 0.1652 | 0.000 |
| Brier Score | 0.2811 | < 0.20 objectif |

## Niveau 2 — Intervalles de Confiance (Bootstrap 95%)

| Métrique | Valeur | CI 95% | Significatif |
|---|---|---|
| AUC ROC | 0.6384 | [0.6249, 0.6515]  ✅ |
| F1 macro | 0.5812 | [0.5691, 0.5930]  ✅ |
| Sensitivity | 0.5401 | [0.5228, 0.5568]  — |
| Specificity | 0.6258 | [0.6081, 0.6439]  — |
| MCC | 0.1663 | [0.1425, 0.1892]  — |
...
| AUC ROC | 0.6383 | p=0.0000 | ✅ p<0.05 |
...
| ECE | 0.2031 | < 0.05 |
| MCE | 0.3320 | < 0.10 |
| Brier Score | 0.2811 | < 0.20 |
| Log-Loss | 0.8483 | minimiser |
...
| AUC ROC | 0.6399 | 0.0564 | 8.8% | 🟢 stable |
