...
**Target :** `stress`  |  **Modèle :** `LSTM_2L`  |  **Exp :** `B`  |  **Date :** 2026-06-13 12:28
...
|---|---|---|
| MAE | 2.4235 | Erreur absolue moyenne (0-10) |
| RMSE | 2.8400 | Erreur quadratique moyenne |
| R² | -0.0284 | 1=parfait, 0=moyenne, <0=pire |

### Classification Binée (Low:0-5 / High:5-10)

| Métrique | Valeur | Baseline aléatoire |
|---|---|---|
| AUC ROC | 0.5332 | 0.500 |
| PR-AUC | 0.4414 | 0.366 |
...
| Métrique | Valeur | Interprétation |
|---|---|---|
| Biais | -0.4727 | proche 0 = pas de biais systématique |
| LoA lower | -5.9678 | limite inférieure d'accord |
| LoA upper | +5.0223 | limite supérieure d'accord |
...
|---|---|---|
| R² | -0.0284 | 0.0000 | 0.0% | 🟢 stable |
| AUC ROC | 0.5332 | 0.0000 | 0.0% | 🟢 stable |
| MAE | 2.4235 | 0.0000 | 0.0% | 🟢 stable |
