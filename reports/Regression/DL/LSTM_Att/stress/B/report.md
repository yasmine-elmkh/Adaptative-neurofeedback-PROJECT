...
**Target :** `stress`  |  **Modèle :** `LSTM_Att`  |  **Exp :** `B`  |  **Date :** 2026-06-14 11:45
...
| RMSE | 2.7740 | Erreur quadratique moyenne |
...
| Log-Loss | 0.7993 | minimiser |

### Bland-Altman (Accord Clinique)

| Métrique | Valeur | Interprétation |
|---|---|---|
| Biais | -0.3095 | proche 0 = pas de biais systématique |
| LoA lower | -5.7189 | limite inférieure d'accord |
| LoA upper | +5.0999 | limite supérieure d'accord |
...
| AUC ROC | 0.5477 | 0.0000 | 0.0% | 🟢 stable |
...
---
*Rapport généré automatiquement par NeuroCap metrics_professional.py — 2026-06-14 11:45*
