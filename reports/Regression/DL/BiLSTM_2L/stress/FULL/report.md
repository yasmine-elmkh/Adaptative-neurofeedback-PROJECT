...
**Target :** `stress`  |  **Modèle :** `BiLSTM_2L`  |  **Exp :** `FULL`  |  **Date :** 2026-06-14 03:06
...
| RMSE | 2.8433 | Erreur quadratique moyenne |
| R² | -0.0308 | 1=parfait, 0=moyenne, <0=pire |

### Classification Binée (Low:0-5 / High:5-10)

| Métrique | Valeur | Baseline aléatoire |
|---|---|---|
| AUC ROC | 0.5571 | 0.500 |
| PR-AUC | 0.4459 | 0.366 |
...
| LoA lower | -5.9946 | limite inférieure d'accord |
| LoA upper | +4.9876 | limite supérieure d'accord |
| LoA width | ±5.4911 | < ±2 pts : excellent |
...
|---|---|---|
| R² | -0.0308 | 0.0000 | 0.0% | 🟢 stable |
| AUC ROC | 0.5571 | 0.0000 | 0.0% | 🟢 stable |
...
---
*Rapport généré automatiquement par NeuroCap metrics_professional.py — 2026-06-14 03:06*
