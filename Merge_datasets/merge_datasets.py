...
COGNITIVE_ARITH = PROJECT_ROOT / "Dataset" / "Cognitive Load Assessment Concentration" / "raw_data" / "Arithmetic_Data"
COGNITIVE_STROOP = PROJECT_ROOT / "Dataset" / "Cognitive Load Assessment Concentration" / "raw_data" / "Stroop_Data"
SAM40_RAW = PROJECT_ROOT / "Dataset" / "Stress_dataset" / "raw_data"
SCALES_FILE = PROJECT_ROOT / "Dataset" / "Stress_dataset" / "scales.xls"
...
def save_merged_dataset(X, y, sids, outdir='Merge_datasets/datasets_merged'):
...
if __name__ == '__main__':
    ...
    save_merged_dataset(X_merged, y_merged, sids_merged, 'Merge_datasets/datasets_merged')
