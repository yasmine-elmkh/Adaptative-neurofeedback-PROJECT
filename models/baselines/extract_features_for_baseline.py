...
def main():
    ...
    possible_paths = [
        script_dir.parent / 'Augmentation' / 'outputs_augmentation' / 'datasets_augmented',
        script_dir.parent / 'augmentation' / 'outputs_augmentation' / 'datasets_augmented',
        script_dir.parent.parent / 'Augmentation' / 'outputs_augmentation' / 'datasets_augmented',
        script_dir / 'datasets_augmented',
    ...
    # ---- Dossier de sortie ----
    out_dir = script_dir / 'datasets_features'
