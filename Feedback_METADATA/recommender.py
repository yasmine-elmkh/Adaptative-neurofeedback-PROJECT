...
class Session:
    ...
    def on_epoch(self, eeg_state: str, eeg_features: dict) -> Optional[dict]:
        """
        ...
        return self._select_and_play(stable_state, eeg_features) if should_change else None

    def _last_item_state(self) -> str:
        return self.item_history[-1].get("eeg_state", "neutral") if self.item_history else "neutral"

    def _select_and_play(self, eeg_state: str, eeg_features: dict) -> dict:
        ...
        media_type = self._choose_media_type(eeg_state)
    ...
    def on_skip(self) -> Optional[dict]:
        self.skip_count += 1
        if self.current_item and self.item_history:
        ...
        return self._select_and_play(self.last_state, self.last_feats)
